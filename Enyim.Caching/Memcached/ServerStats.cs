...
namespace Enyim.Caching.Memcached
{
	...
	public sealed class ServerStats
	{
		...
		private static readonly Enyim.Caching.ILog log = LogManager.GetLogger(typeof(ServerStats));
		...
		public IEnumerable<KeyValuePair<IPEndPoint, string>> GetRaw(string key)
		{
			...
			return results.Select(kvp => new KeyValuePair<IPEndPoint, string>(kvp.Key, kvp.Value != null &&  kvp.Value.TryGetValue(key, out tmp) ? tmp : null)).ToList();
		}
	}
}
